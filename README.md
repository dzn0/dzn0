...
<img src="https://skillicons.dev/icons?i=js,ts,nextjs,react,nodejs,express,tailwind,postgres,prisma,git,github,vercel,figma,ps,ai,vscode,npm&theme=dark&perline=9" alt="Tecnologias" />
...
**OUTRAS FERRAMENTAS**
<br/>
<sub>SQL · Claude API (Anthropic) · Mercado Pago (Pix) · Visual Studio · Canva · CorelDRAW</sub>
